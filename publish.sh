...
url=`curl -H "Authorization: Bearer $NETLIFY_ACCESS_TOKEN" https://api.netlify.com/api/v1/sites/silly-fermat-3bc2e9/deploys`
...
curl -X POST -H "Authorization: Bearer $NETLIFY_ACCESS_TOKEN" -d "{}" "https://api.netlify.com/api/v1/sites/silly-fermat-3bc2e9/deploys/${temp##*|}/restore"
